...
func (m *ImmutableChatParticipant) IsChatMemberNormal() bool {
	return m.ParticipantType == ChatMemberNormal
}

func (m *ImmutableChatParticipant) IsChatMemberAdmin() bool {
	return m.ParticipantType == ChatMemberAdmin
}

func (m *ImmutableChatParticipant) IsChatMemberCreator() bool {
	return m.ParticipantType == ChatMemberCreator
}
...
func (m *ImmutableChatParticipant) ToChatParticipant() *ChatParticipant {
